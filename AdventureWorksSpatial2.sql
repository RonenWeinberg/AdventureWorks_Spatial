/*
Here's an example of the use of spatial functions in SQL
in AdventureWorks2019 DB. 
In this query I use the STDistance method to calculate the distance 
between on-line orders locations to the nearest store location in US.
As you can see from the results, although the on-line orders are not related
to any real store, they are all located in a near-by area.
*/
